...
export const colors = {
  ...
  gray: {
    100: {dark: '26 26 26', light: '242 242 242' },
    200: {dark: '31 31 31', light: '235 235 235' },
    300: {dark: '41 41 41', light: '230 230 230' },
    400: {dark: '46 46 46', light: '235 235 235' },
    500: {dark: '69 69 69', light: '201 201 201' },
    600: {dark: '135 135 135', light: '168 168 168' },
    700: {dark: '143 143 143', light: '143 143 143' },
    800: {dark: '125 125 125', light: '125 125 125' },
    900: {dark: '161 161 161', light: '102, 102, 102' },
    1000: {dark: '237 237 237', light: '23, 23, 23' }
  }
} as const;
